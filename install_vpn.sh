...
main() {
  ...
  # Generate shared UUID
  V2RAY_UUID=$(uuidgen)
  echo "Shared V2Ray UUID: $V2RAY_UUID"
  ...
  echo "Setup complete! Run again, select option 3 to view your info."
}
...
while true; do
  ...
  case "$choice" in
    1) main ;;
    2) panel_login; manage_users_panel ;;
    3) show_vpn_info ;;
